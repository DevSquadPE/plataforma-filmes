...
async function login(userEmail, password) {
    ...
    if (userFound) {
        ...
        if (senha === password) {
            ...
            // window.location = `${window.location.origin}/pages/home.html`; // para uso local
            window.location = `${window.location.origin}/plataforma-filmes/pages/home.html`; // uso github
        } else {
